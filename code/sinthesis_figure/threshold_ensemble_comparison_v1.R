...
###hacer funcion primero por threshold y luego dentro que corra todas las especies? it should be fast
...
for(i in 1:length(epithet_species_list)){
    ...
    for(selected_threshold in 0:100){
        ...
        print(future_suitable_area_elsewhere >= future_suitable_area_inside_current_range)
        ...
        suitability_changes = rbind.data.frame(suitability_changes, cbind.data.frame(species, selected_threshold, range_change, range_loss))
    }
