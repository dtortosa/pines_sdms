...
#color pallete for gain and loss species
colfunc_gain_loss <- colorRampPalette(c("red3", "gray93", "green4"))

##plot
pdf("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/global_figures/final_global_figures/current_future_suit.pdf", width=12, height=12)
...
#sum suitability across species
plot(crop(differ_suit_no_phylo, plot_extent), add=TRUE, col=colfunc_gain_loss(181), breaks=seq(-9,9,0.1), axes=FALSE, box=FALSE, axis.args=list(at=seq(-9,9,2), cex.axis=1.3), legend=TRUE, legend.shrink=0.8, legend.args=list(text=expression(bold(paste(Delta~'pine richness'))), side=4, font=2, line=3.2, cex=1.7)) #colors of colorbrewer2 can be seen at "http://colorbrewer2.org/#type=sequential&scheme=YlOrRd&n=3"
...
#sum suitability across species
plot(crop(differ_suit_phylo, plot_extent), add=TRUE, col=colfunc_gain_loss(181), breaks=seq(-9,9,0.1), axes=FALSE, box=FALSE, axis.args=list(at=seq(-9,9,2), cex.axis=1.3), legend=TRUE, legend.shrink=0.8, legend.args=list(text=expression(bold(paste(Delta~'pine richness'))), side=4, font=2, line=3.2, cex=1.7)) #colors of colorbrewer2 can be seen at "http://colorbrewer2.org/#type=sequential&scheme=YlOrRd&n=3"
dev.off()
...
##plot
pdf("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/global_figures/final_global_figures/phylo_no_phylo_difference.pdf", width=20, height=8)
...
#save it
write.table(differ_percent, "/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/global_figures/final_global_figures/differ_phylo_inside.csv", col.names = TRUE, row.names = FALSE, sep=",")