...
bio_moisture[["bio15"]] = calc(moisture, sd) #use calc for calculate the sd of the raster of the stack, and change bio15 form biovars by our variable. We don't multiply by 100, as Hiijmans make in Temperature seasonality, this is a method to use less memory. Rafi told that it is nor neccesary. 
