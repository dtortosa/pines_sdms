...
evaluations = read.table("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/evaluations/medians_evaluations_v3.csv", sep=",", header=TRUE)
str(evaluations)
...
medians_across_sp["glm_auc_median"]; medians_across_sp["gam_auc_median"]
sd_across_species["glm_auc_median"]; sd_across_species["gam_auc_median"]
