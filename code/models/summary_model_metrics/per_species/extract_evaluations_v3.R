...
colnames(medians_evaluations) <- c("species", "glm_kappa_median", "glm_kappa_sd", "glm_tss_median", "glm_tss_sd", "glm_auc_median", "glm_auc_sd", "gam_kappa_median", "gam_kappa_sd", "gam_tss_median", "gam_tss_sd", "gam_auc_median", "gam_auc_sd", "rf_kappa_median", "rf_kappa_sd", "rf_tss_median", "rf_tss_sd")
...
#save the results
write.table(medians_evaluations, "medians_evaluations/medians_evaluations_v3.csv", sep=",", col.names=TRUE, row.names=FALSE)