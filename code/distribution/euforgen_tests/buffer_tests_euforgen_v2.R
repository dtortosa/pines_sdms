...
#nigra
plot(distr_nigra) 
distr_crop_nigra =  crop(distr_nigra,c(-13.18, 45, 30, 55))
plot(distr_crop_nigra)
#pinaster
plot(distr_pinaster) 
distr_crop_pinaster =  crop(distr_pinaster,c(-13.18, 40, 27, 47))
...
#halepensis
polygon_halepensis_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_halepensis/Pinus_halepensis_EUFORGEN.shp")
...
#brutia
polygon_brutia_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_brutia/Pinus_brutia_EUFORGEN.shp")
polygon_brutia_euforgen  = spTransform(polygon_brutia_euforgen, new.CRS) 
#cembra
polygon_cembra_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_cembra/Pinus_cembra_EUFORGEN.shp")
polygon_cembra_euforgen  = spTransform(polygon_cembra_euforgen, new.CRS) 
#nigra
polygon_nigra_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_nigra/Pinus_nigra_EUFORGEN.shp")
polygon_nigra_euforgen  = spTransform(polygon_nigra_euforgen, new.CRS) 
#pinaster
polygon_pinaster_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_pinaster/Pinus_pinaster_EUFORGEN.shp")
...
#sylvestris
polygon_sylvestris_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_sylvestris/Pinus_sylvestris_EUFORGEN.shp")
...
#heldreichii
polygon_heldreichii_euforgen = shapefile("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/datos/raw_ocurrences/shapefiles/shapefiles/Pinus_heldreichii/Pinus_leucodermis_EUFORGEN.shp") #Pinus leucodermis is a synonym of P. heldreichii "http://www.theplantlist.org/tpl1.1/record/kew-2561818"
...
plot(overlap_pinea)
#sylvestris
#create a zero-width buffer for avoidng an error with inersect "TopologyException: Input geom 1 is invalid". See "xchange.com/questions/163445/getting-topologyexception-input-geom-1-is-invalid-which-is-due-to-self-intersec"
polygon_sylvestris_atlas = gBuffer(polygon_sylvestris_atlas, byid=TRUE, width=0)
polygon_sylvestris_euforgen = gBuffer(polygon_sylvestris_euforgen, byid=TRUE, width=0)
...
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/atlas_v2.png", width=1200, height=1200, pointsize=30)
par(mfcol=c(3,3))
plot(distr_crop_halepensis)
plot(distr_crop_brutia)
plot(distr_crop_cembra)
...
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/euforgen_v2.png", width=1200, height=1200, pointsize=30)
par(mfcol=c(3,3))
...
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/atlas_sobre_euforgen_v2.png", width=1200, height=1200, pointsize=30)
par(mfcol=c(3,3))
plot(polygon_halepensis_euforgen)
...
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/euforgen_sobre_atlas_v2.png", width=1200, height=1200, pointsize=30)
par(mfcol=c(3,3))
...
#halepensis
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_halepensis_v2.png", width=1200, height=1200, pointsize=30)
...
dev.off()
#brutia
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_brutia_v2.png", width=1200, height=1200, pointsize=30)
...
dev.off()
#cembra
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_cembra_v2.png", width=1200, height=1200, pointsize=30)
...
dev.off()
#nigra
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_nigra_v2.png", width=1200, height=1200, pointsize=30)
plot(crop(bio1,c(-13.18, 45, 30, 55)), col="gray80", main="P. nigra")
plot(polygon_nigra_euforgen, col="red", add=T)
plot(polygon_nigra_atlas, add=T)
legend(x="topright", legend=c("EUFORGEN", "Critfield"), fill=c("red", "white"), cex=0.8)
dev.off()
#pinaster
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_pinaster_v2.png", width=1200, height=1200, pointsize=30)
...
dev.off()
#pinea
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_pinea_v2.png", width=1200, height=1200, pointsize=30)
...
dev.off()
#sylvestris
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_sylvestris_v2.png", width=1200, height=1200, pointsize=30)
plot(crop(bio1, c(-13.18, 140, 27, 75)), col="gray80", main="P. sylvestris")
plot(polygon_sylvestris_euforgen, col="red", add=T)
plot(polygon_sylvestris_atlas, add=T)
legend(x="topright", legend=c("EUFORGEN", "Critfield"), fill=c("red", "white"), cex=0.8)
dev.off()
#peuce
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_peuce_v2.png", width=1200, height=1200, pointsize=30)
...
dev.off()
#heldreichii
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_atlas_euforgen/overlap_heldreichii_v2.png", width=1200, height=1200, pointsize=30)
...
#halepensis
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_halepensis_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(-13.18, 40, 30, 47)), col="gray80", main="P. halepensis")
plot(polygon_halepensis_euforgen, col="red", add=T)
plot(polygon_halepensis_atlas, add=T)
...
dev.off()
#brutia
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_brutia_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(17, 55, 25, 50)), col="gray80", main="P. brutia")
plot(polygon_brutia_euforgen, col="red", add=T)
plot(polygon_brutia_atlas, add=T)
...
dev.off()
#cembra
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_cembra_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(-5, 50, 30, 55)), col="gray80", main="P. cembra")
plot(polygon_cembra_euforgen, col="red", add=T)
plot(polygon_cembra_atlas, add=T)
...
dev.off()
#nigra
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_nigra_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(-13.18, 45, 30, 55)), col="gray80", main="P. nigra")
plot(polygon_nigra_euforgen, col="red", add=T)
plot(polygon_nigra_atlas, add=T)
...
dev.off()
#pinaster
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_pinaster_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(-13.18, 40, 27, 47)), col="gray80", main="P. pinaster")
plot(polygon_pinaster_euforgen, col="red", add=T)
plot(polygon_pinaster_atlas, add=T)
legend(x="topright", legend=c("EUFORGEN", "Critfield"), fill=c("red", "white"), cex=0.5)
plot(crop(bio1, c(-13.18, 40, 30, 47)), col="gray80", main="P. pinaster")
...
dev.off()
#pinea
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_pinea_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(-13.18, 47, 30, 47)), col="gray80", main="P. pinea")
plot(polygon_pinea_euforgen, col="red", add=T)
plot(polygon_pinea_atlas, add=T)
...
dev.off()
#sylvestris
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_sylvestris_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
...
dev.off()
#peuce
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_peuce_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(10, 30, 30, 50)), col="gray80", main="P. peuce")
plot(polygon_peuce_euforgen, col="red", add=T)
plot(polygon_peuce_atlas, add=T)
...
dev.off()
#heldreichii
png("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/overlap_buffer_euforgen/overlap_buffer_euforgen_heldreichii_v2.png", width=1500, height=600, pointsize=30)
par(mfcol=c(1,2))
plot(crop(bio1, c(10, 30, 30, 50)), col="gray80", main="P. heldreichii")
plot(polygon_heldreichii_euforgen, col="red", add=T)
plot(polygon_heldreichii_atlas, add=T)
...
##figure paper
pdf("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/ocurrences/buffer/figure_paper_v2.pdf")
#set graphic parameters
par(mfcol=c(5,2), mar=c(0,2,0,4)+0.1, oma = c(0,0.5,2,0), mai=c(0.4,0.5,0.1,0.1))

#brutia
plot(crop(bio1, c(20, 47, 32.5, 50)), col="gray80", legend=FALSE)
...
#sylvestris
plot(crop(bio1, c(-13.18, 143, 27, 75)), col="gray80", legend=FALSE)
...
#save work.space
save.image("/Volumes/GoogleDrive/My Drive/science/phd/nicho_pinus/results/rdata/buffer_distribution_area_v2.RData")
require(raster)