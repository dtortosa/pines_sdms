...
#color pallete for sequence (uncertainity of suitability).
...
plot_suples = function(species, size="medium"){
    ...
    plot(current_suit,  col=colfunc_sequence(101), breaks=seq(0,100,1), main="", axis.args=list(at=seq(0,100,20),cex.axis=1.5), add=T)
    ...
    ###Pannel 3
    plot(aquatic_bodies, col=colfunc_water_terrestrial(2), legend=FALSE)     
    plot(projected_suit, col=colfunc_sequence(101), breaks=seq(0,100,1), main="", axis.args=list(at=seq(0,100,20),cex.axis=1.5), add=T)
