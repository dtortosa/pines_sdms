...
text(x=-50, y=-310, labels = estimate_bio17_bm, cex=1)
...
text(x=-50, y=-360, labels = p_bio17_bm, cex=1)
...
text(x=-120, y=-325, labels = estimate_bio17_ou, cex=1)
...
text(x=-120, y=-360, labels = p_bio17_ou, cex=1)
