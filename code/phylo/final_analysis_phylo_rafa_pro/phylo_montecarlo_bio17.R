...
simulations_ou.1_bio17 = pmc(phy, datos, "BM", "OU", nboot=2000, mc.cores=4)

### save simulations
save(simulations_ou.1_bio17, file="//Users/dsalazar/nicho_pinus/results/rdata/bio_17_geiger_BM_OU.1_nboot_2000.rda")

### load it
#load("/Users/dsalazar/nicho_pinus/results/rdata/bio_17_geiger_BM_OU.1_nboot_2000.rda")
...
pdf("/Users/dsalazar/nicho_pinus/results/pmc/figures/bio_17_geiger_BM_OU_1_nboot_2000.pdf")
par(mfrow=c(2,2))
