...
phylo_analyses = function(species){
    ...
    writeRaster(second_ensamble_phylo, paste("/Users/dsalazar/nicho_pinus/results/final_analyses/phylo_ensamble/without_proportions/", species, "_phylo_ensamble_without_proportions.asc", sep=""), overwrite=TRUE)
    writeRaster(second_ensamble_phylo_proportion, paste("/Users/dsalazar/nicho_pinus/results/final_analyses/phylo_ensamble/with_proportions/", species, "_phylo_ensamble_with_proportions.asc", sep=""), overwrite=TRUE)
}
